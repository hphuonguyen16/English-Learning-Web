...
public class QuizServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (action_parameter.equals("showAddForm")) {
			try {
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("./admin/addQuestion_admin.jsp");
    ...
    private void showAllQuestions_admin(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("./admin/questions_admin.jsp");
		dispatcher.forward(request, response);
	}
