  ...
  <div class="question-bar">
	...
	<script>
		...
		function clickRight(){
			...
			console.log(temp);
			var a = temp + 1;
			var qestion = document.createElement('h2');
			qestion.id = "qestion";
			qestion.innerHTML = "Question "+a+": " +questions[temp].question;
		...
		function calculatePoints(){
			if(temp<questions.length){
				...
				document.getElementById("quize").style.zIndex = "-1000";
				document.getElementsByClassName("background")[0].style.opacity = "1";	
				document.getElementsByClassName("card")[0].style.opacity = "1";
				document.getElementsByClassName("card")[0].style.animation = "bounceIn 0.5s 1";
		}
		function close1(){
				document.getElementsByClassName("card")[0].style.display = "none";
		}
	</script>
    <h2 id="qestion" className="backInLeft">Question 1:<%=questions.get(0).getQuestion() %> </h2>
...
<div class="card">
      ...
      <div class = "card-container">
        ...
        <a href="LessonServlet?action=getLessons"><button class="btn">Practice more</button></a>
   		</div>
</div>
</div>
